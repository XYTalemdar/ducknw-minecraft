...
export default function GirisYapPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-950 via-amber-950/20 to-zinc-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-400">
            Hesabınız yok mu?{" "}
            <Link href="/kayit-ol" className="text-amber-400 hover:text-amber-300 font-semibold">
              Kayıt Ol
            </Link>
          </p>
        </div>
